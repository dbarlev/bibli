    ...
    return (
      <Grid fluid id="slider" className="text-center">
        <Jumbotron>
            ...
            <p id="slider-btn">
                <Button bsStyle="primary" className="btn-yellow blue-text"> <Link className="bold black" to="/register"> קפצו להרשמה <i className="fas fa-chevron-left btn-yellow"></i></Link></Button>
            </p>
        </Jumbotron>
